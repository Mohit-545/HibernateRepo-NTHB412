//JPAQBC_SelectOperationTest_WithCondition.java
package com.nt.test;
...
public class JPAQBC_SelectOperationTest_WithCondition {
    public static void main( String[] args ) {
        ...
        try(factory;ses){
        	...
        	ctQuery.select(root).where(ctBuilder.and(ctBuilder.ge(root.get("price"),5000.0), ctBuilder.le(root.get("price"),20000.0)));
