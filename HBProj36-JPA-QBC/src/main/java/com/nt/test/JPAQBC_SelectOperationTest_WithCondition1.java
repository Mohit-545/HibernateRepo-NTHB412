//JPAQBC_SelectOperationTest_WithCondition1.java
package com.nt.test;
...
public class JPAQBC_SelectOperationTest_WithCondition1 {
    public static void main( String[] args ) {
        ...
        try(factory;ses){
        	...
        	//apply where and orderby clause condition
        	ctQuery.select(root).where(root.get("pname").in("Chair","Bed","TV")).orderBy(ctBuilder.asc(root.get("price")));
